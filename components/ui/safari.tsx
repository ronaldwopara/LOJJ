  ...
  return (
    ...
    >
      ...
      {!hasMedia && hasChildren && (
        <div
          className="demo-ui-font pointer-events-auto absolute z-0 overflow-hidden bg-white"
          style={{
            left: `${LEFT_PCT}%`,
            top: `${TOP_PCT}%`,
            width: `${WIDTH_PCT}%`,
      ...
      >
        ...
        <g clipPath="url(#path0)" mask={hasMedia || hasChildren ? "url(#safariPunch)" : undefined}>
          <path
